...
public class NeuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        estadoLlanta = (Spinner)findViewById(R.id.spinLlanta);
        ...
        final Button btnSigNeuJg = (Button)findViewById(R.id.btnSigNeuJg);
