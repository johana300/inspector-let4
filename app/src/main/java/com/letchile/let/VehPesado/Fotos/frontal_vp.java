        ...
        btnFotoPosterior.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isDirectoryCreated){
                    ...
                    String imageName = fecha + "_Foto_Dano_Frontal_VP.jpg";
        ...
        btnFotoAdicionalPosterior.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isDirectoryCreated){
                    ...
                    String fecha = dateFormat.format(date);
                    String imageName = fecha + "_Foto_Adicional_Frontal_VP.jpg";
                    ruta = file.toString() +"/" +imageName;
                    mPath =  ruta ;
            ...
            public void onClick(View view) {
                if(edtDescripcionDañoPvp.length()<=0){
                    ...
                    if (isDirectoryCreated) {
                        ...
                        String fecha = dateFormat.format(date);
                        String imageName = fecha + "_Foto_Ddano_Frontal_VP.jpg";
                        ruta = file.toString() + "/" + imageName;
                        mPath = ruta;
        ...
        if(resultCode== RESULT_OK){
            switch(requestCode){
                case TAKE_POSTERIOR:
                    ...
                    db.insertaFoto(Integer.parseInt(id_inspeccion),db.correlativoFotos(Integer.parseInt(id_inspeccion)),nombreimagen, "Frontal",0,imagenPosterior);
                ...
                case TAKE_ADDPOVP:
                    ...
                    db.insertaFoto(Integer.parseInt(id_inspeccion),db.correlativoFotos(Integer.parseInt(id_inspeccion)),nombreimagen, "Adicional Frontal",0,imagenAddPosterior);
